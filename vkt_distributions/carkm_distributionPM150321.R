...
oac_value <- distribution$HHoldOAClass2011_B03ID[j]
  ...
  subgroup <- tripsfocus %>% filter(SexAgeconst == sexage_value & 
                                      HHoldOAClass2011_B03ID == oac_value 
                                    & TripStartHours > 11)
...
write_csv(tripdist,"spss19/PMsubpopgroupvarsSexageOACbikeown150321.csv")  
